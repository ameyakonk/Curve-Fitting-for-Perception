...
class LineFitter:
    ...
    def RANSAC(self):
        ...
        for i in range(max_Iterations):
            ...
            also_inliers_y = []
            thisErr = 0
            #print(random_x[ransac_minpoint:][0])
            ...
            #print(also_inliers_x)
            #print(also_inliers_y)
    ...
    def plot(self):
        ...
        x_ransac, y_ransac = self.RANSAC()
        
        fig = plt.figure(figsize = (12, 7))
        plt.plot(x, y, 'r')
        plt.plot(x_tls, y_tls, 'k-')
        plt.plot(x_ransac, y_ransac, 'g')
